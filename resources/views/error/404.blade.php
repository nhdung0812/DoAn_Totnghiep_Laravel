...
<html lang="en">
       <head>
              ...
              <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('Admin/image/avatar/favi.png') }}">
...
<body>
       <body>
              ...
              <div id="page-container" class="main-content-boxed side-trans-enabled">
                  ...
                  <!-- Main Container -->
                  <main id="main-container" style="min-height: 347px;">
                      <!-- Page Content -->
                          ...
                          <div class="hero-inner">
                              <div class="content content-full">
                                  <div class="py-30 text-center">
                                      ...
                                      <h1 class="h2 font-w700 mt-30 mb-10">Bạn Không có quyên truy cập trang này !!!</h1>
                                      <h2 class="h3 font-w400 text-muted mb-50">We are sorry but the page you are looking for was not found..</h2>
                                      <a class="btn btn-hero btn-rounded btn-alt-secondary" href="{{ route('Quantri.Admin') }}">
                                          <i class="fa fa-arrow-left mr-10"></i> Quay lại
                                      </a>
                                  </div>
                              </div>
                          </div>
