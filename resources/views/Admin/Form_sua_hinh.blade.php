    ...
    <div class="content">
        ...
        <div class="block-content">
            <form class="js-validation-material" enctype="multipart/form-data"
                action="{{ route('Quantri.sua_hinh_anh') }}" role="form" id="Creatr_Product_Tour"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <select class="form-control" id="ma_dia_diem" name="ma_dia_diem">
                            <option value="{{ $hinh[0]->ma_dia_diem }} " selected>{{ $hinh[0]->ten_dia_diem }}</option>
                ...
                <input type="hidden" name="hinh" id="hinh" value="{{ $hinh[0]->ma_hinh_anh }}">
                <div class="form-group row">
                    <div class="col-md-12">
                        <div class="block block-rounded block-themed">
                            <div class="block-header bg-gd-primary">
                                <h3 class="block-title">SỬA HÌNH ẢNH ĐỊA ĐIỂM</h3>
                            </div>
                            <div class="col-md-4">
                                <div class="box">
