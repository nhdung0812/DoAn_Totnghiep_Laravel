                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <a href="{{route('Quantri.ds_khu_vuc')}}" type="button" class="show-trash btn btn-danger mr-5 mb-5">
                                <i class=""></i>Quay Lại
                            </a>
                        </div>
                                ...
                                <tbody>
                                   @foreach($trash_khuvuc as $dd)
                                    <tr>
                                        ...
                                        <td class="" style="">
                                            <a href="{{ route('Quantri.phuc_hoi_khu_vuc',$dd->ma_mien) }}"  type="submit" class=" btn btn-primary min-width-90">
                                                <i class="fa fa-wrench"></i> Phục hồi
                                            </a>
                                            <a href="{{ route('Quantri.xoa_vinh_vien_khu_vuc',$dd->ma_mien) }}" title="" type="submit" class="delect-vinhvien btn btn-danger  min-width-10 ">
