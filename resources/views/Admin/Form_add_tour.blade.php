...
<main id="main-container" style="min-height: 523px;">
                ...
                <div class="content">
                    <!-- Bootstrap Design -->
                    <h2 class="content-heading">THÊM CHƯƠNG TRÌNH TOUR</h2>
                    <div class="row">
                        <div class="col-md-12">
                            @if ($errors->any())
                                <ul>
                                    ...
                                    <form action="{{ route('Quantri.Xu_ly_them_tour') }}" method="post" id="them_chuong_trinh" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12 ">
                                                ...
                                                <input type="text" class="form-control {{ $errors->has('ten_tour') ? 'is-invalid' : '' }} " id="ten_tour" name="ten_tour" placeholder="abd@gmail.com" value="{{ old('ten_tour') }}">
                                        ...
                                        <div class="form-group row">
                                            <div class="block col-12">
                                                <div class=" block-content-full">
                                                    ...
                                                    <textarea class="js-summernote {{ $errors->has('noi_dung') ? 'is-invalid' : '' }}" name="noi_dung" id="noi_dung" cols="30" rows="10" value="{{ old('noi_dung') }}"></textarea>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 ">
                                                ...
                                                <input type="text" class="form-control {{ $errors->has('gia_tour') ? 'is-invalid' : '' }}" id="gia_tour" name="gia_tour" placeholder="abd@gmail.com" value="{{ old('gia_tour') }}" >
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="number " class="form-control {{ $errors->has('so_ngay') ? 'is-invalid' : '' }}" id="so_ngay" name="so_ngay" min="1" max="50" placeholder="1" >
                                                <span class="text-danger">{{ $errors->first('so_ngay') }}</span>

                                            </div>
                                            <div class="col-md-6 ">
                                                <label for="">Số đêm<span class="text-danger">(*)</span></label>
                                                <input type="number" class="form-control {{ $errors->has('so_dem') ? 'is-invalid' : '' }}" id="so_dem" min="1" max="50" name="so_dem" placeholder="3"   >
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 ">
                                                ...
                                                <input type="text" class="form-control {{ $errors->has('noi_dung') ? 'is-invalid' : '' }}" id="khuyen_mai" name="khuyen_mai" placeholder="20%" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="goi_tour" name="goi_tour" placeholder="" >
