...
<main id="main-container" style="min-height: 550px;">
    ...
    <div class="content">
            ...
            <div class="col-md-6 col-xl-4">
                <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                    <div class="block-content block-content-full block-sticky-options">
                        ...
                        <div class="py-20 text-center">
                            <div class="font-size-h2 font-w700 mb-0 text-success js-count-to-enabled"
                                data-toggle="countTo" data-to="85">85</div>
        ...
        <form class="row gutters-tiny" action="{{ route('Quantri.Xu_ly_them_tour') }}" method="post"
            id="them_chuong_trinh" name="them_chuong_trinh" enctype="multipart/form-data">
            {{ csrf_field() }}
            <!-- Basic Info -->
            <div id="test">
                ...
                <div class="block block-rounded block-themed">
                    ...
                    <div class="block-content block-content-full">
                        <div class="form-group row">
                            <label class="col-12" for="ecom-product-name">Tên Chương Trình Tour<span
                                    class="text-danger">(*)</span></label>
                            <div class="col-12">
                                <input type="text"
                                    class="form-control {{ $errors->has('ten_tour') ? 'is-invalid' : '' }} "
                                    id="ten_tour" name="ten_tour" placeholder="" value="{{ old('ten_tour') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <textarea class="{{ $errors->has('noi_dung') ? 'is-invalid' : '' }}" name="noi_dung"
                                    id="noi_dung" value="{{ old('noi_dung') }}"></textarea>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label class="col-12  pl-0" for="ecom-product-price">Giá Tiền<span
                                        class="text-danger">(*)</span></label>
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        class="form-control {{ $errors->has('gia_tour') ? 'is-invalid' : '' }}"
                                        id="gia_tour" name="gia_tour" placeholder="2000000"
                                        value="{{ old('gia_tour') }}">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="khuyen_mai" value="{{ old('khuyen_mai') }}" name="khuyen_mai"
                                        placeholder="20%">
                                </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label class="col-12  pl-0" for="ecom-product-price">Số Ngày<span
                                        class="text-danger">(*)</span></label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                    ...
                                    <input type="number " value="{{ old('so_ngay') }}"
                                        class="form-control {{ $errors->has('so_ngay') ? 'is-invalid' : '' }}"
                                        id="so_ngay" name="so_ngay" min="1" max="50" placeholder="1">
                                </div>
                                <span class="text-danger">{{ $errors->first('so_ngay') }}</span>
                            </div>

                            <div class="col-sm-6">
                                <label class="col-12 pl-0" for="ecom-product-stock">Số Đêm<span
                                        class="text-danger">(*)</span></label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                    ...
                                    <input type="number"
                                        class="form-control {{ $errors->has('so_dem') ? 'is-invalid' : '' }}"
                                        id="so_dem" min="1" max="50" name="so_dem" value="{{ old('so_dem') }}"
                                        placeholder="3">
                                </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label class="col-12  pl-0" for="ecom-product-price">Số chỗ<span
                                        class="text-danger">(*)</span></label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
            ...
            <div class="col-md-5">
                ...
                <div class="block block-rounded block-themed">
                    <div class="block-header bg-gd-primary">
                        <h3 class="block-title"><i class="fas fa-map-marked-alt"></i>KHU VỰC<span
                                class="text-danger">(*)</span></h3>
                    </div>
                    <div class="block-content block-content-full">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <select class="form-control {{ $errors->has('khu_vuc') ? 'is-invalid' : '' }}"
                                    id="khu_vuc" name="khu_vuc">
                        ...
                        <div class="row gutters-tiny items-push">
                            <div class="col-12">
                                ...
                                <div class="custom-file">
                                    <input type="file"
                                        class="custom-file-input  {{ $errors->has('hinh_tour') ? 'is-invalid' : '' }} "
                                        id="hinh_tour" name="hinh_tour" data-toggle="custom-file-input">
                                ...
                                <img id="up_holder" class="img-avatar"
