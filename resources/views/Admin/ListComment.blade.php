       ...
       <main id="main-container">
                ...
                <div class="content">
                     <h2 class="content-heading">
                            <i class="fa fa-word mr-2"></i>Danh sách Comment
                     </h2>
                    <!-- Dynamic Table Full -->
                    <div class="block">
                                ...
                                <thead>
                                    <tr>
                                        <tr class="post">
                                            ...
                                            <th class="d-none d-sm-table-cell">Tên Tour Comment</th>
                                            <th class="d-none d-sm-table-cell">Tên Người Comment</th>
                                            <th class="d-none d-sm-table-cell">Nội dung comment</th>
