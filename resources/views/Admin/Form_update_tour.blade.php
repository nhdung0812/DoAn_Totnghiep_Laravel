...
<main id="main-container" style="min-height: 550px;">
    ...
    <div class="content">
        ...
        <form class="row gutters-tiny" action="{{ route('Quantri.Xu_ly_them_tour') }}" method="post" id="them_chuong_trinh" name="them_chuong_trinh" enctype="multipart/form-data">
            ...
            <!-- Basic Info -->
            <div class="row">
            @for ($i = 0; $i < count($get_diadiem); $i++)
                <input type="hidden" name="diadiemlist[]" id="diadiemlist" value="{{ $get_diadiem[$i]->ma_dia_diem }}">
            @endfor
            </div>
            <div id="test">
                        ...
                        <div class="block block-rounded block-themed">
                            ...
                            <div class="block-content block-content-full">
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control {{ $errors->has('ten_tour') ? 'is-invalid' : '' }} " id="ten_tour" name="ten_tour" placeholder="" value="{{ old('ten_tour')}} {{ $tour[0]->ten_tour}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12">
                                        <textarea class="{{ $errors->has('noi_dung') ? 'is-invalid' : '' }}" name="noi_dung" id="noi_dung" value="{{ old('noi_dung') }} ">{{ $tour[0]->noi_dung}}</textarea>
                                ...
                                <div class="form-group row">  
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('gia_tour') ? 'is-invalid' : '' }}" id="gia_tour" name="gia_tour" placeholder="2000000" value="{{ old('gia_tour')  }} {{ $tour[0]->gia_tour }}" >
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('khuyen_mai') ? 'is-invalid' : '' }}" id="khuyen_mai" value="{{ old('khuyen_mai') }} {{ $tour[0]->khuyen_mai }}" name="khuyen_mai" placeholder="20%" >
                                        </div>
                                ...
                                <div class="form-group row">  
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number " value="{{ old('so_ngay') }} {{ $tour[0]->so_ngay }}" class="form-control {{ $errors->has('so_ngay') ? 'is-invalid' : '' }}" id="so_ngay" name="so_ngay" min="1" max="50" placeholder="1" >
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control {{ $errors->has('so_dem') ? 'is-invalid' : '' }}" id="so_dem" min="1" max="50" name="so_dem" value="{{ old('so_dem') }}{{ $tour[0]->so_ngay }}" placeholder="3"   >   
                                        </div>
                                ...
                                <div class="form-group row">  
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control {{ $errors->has('so_cho') ? 'is-invalid' : '' }}" value="{{ old('so_cho') }}{{ $tour[0]->so_cho }}" id="so_cho" name="so_cho" min="10" max="100" placeholder="20" >
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control {{ $errors->has('loai_tour') ? 'is-invalid' : '' }}" id="loai_tour" name="loai_tour">
                                            ...
                                            @foreach ($loai_tour as $item)
                                                <option value= "{{ $item->ma_loai_tour }}" {{ old('loai_tour') == $item->ma_loai_tour ? 'selected' : ''}} {{ $tour[0]->ma_loai_tour == $item->ma_loai_tour ? 'selected' : ''}}>{{ $item->ten_loai_tour }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <select class="form-control {{ $errors->has('khu_vuc') ? 'is-invalid' : '' }}" id="khu_vuc" name="khu_vuc">
                                        ...
                                        @foreach ($get_khuvuc as $item)
                                            <option value = "{{ $item->ma_mien }} {{ old('khu_vuc') == $item->ma_mien ? 'selected' : '' }}" {{ $khuvuc[0]->ma_mien == $item->ma_mien ? 'selected' : '' }} >{{ $item->ten_mien }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="block-content block-content-full">
                            ...
                            <div class="row gutters-tiny items-push" id="previews">
                                <div class="col-sm-6 col-xl-4" id="template-preview" style="display: none;">
                                    <div class="options-container mr-2">
                                        <img data-dz-thumbnail class="img-fluid options-item" src="assets/media/photos/photo8.jpg" alt="">
                                        <div class="options-overlay bg-black-op-75">
                                            <div class="options-overlay-content">
                                                <a class="btn btn-sm btn-rounded btn-alt-danger min-width-75 dz-remove" href="javascript:void(0)"  data-dz-remove>
                            ...
                            <div class="row  gutters-tiny items-push">
                                <div class="col-md-12">
                                    ...
                                    <div class="dropzone dz-clickable dz-default dz-message" id="my-dropzone">
                                        <div class="dz-default dz-message" data-dz-message>
                                          <span>Thêm hình ảnh địa điểm</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
             ...
             $("#my-dropzone").dropzone({
               ...
               success : function(file, response){
                   console.log('vào nè');
                    ...
                    //addedFilesHash[file.name] = response.name;
               },
               init : function() {
                   //var submit = document.querySelector("#them_hinh_dia_diem")
                   //myDropzone = this;
                    this.on("addedfile", function(file){
                        $('#test').append('<input type="hidden" name="image[]" value="'+file.name+'">');
                    });
