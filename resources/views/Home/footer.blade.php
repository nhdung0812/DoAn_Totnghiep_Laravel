    ...
    <div class="space-bottom-2 space-top-1">
        <div class="container">
            <div class="row justify-content-xl-between">
                        ...
                        <div class="mb-5 mr-md-7 mr-lg-0">
                            ...
                            <a href="tel:(888)-1234-56789">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="mb-2 h6 font-weight-normal text-gray-1">Bạn có câu hỏi nào ? Gọi cho chúng tôi 24/7!</div>
                                        <small class="d-block font-size-18 font-weight-normal text-primary">Hotline: <span class="text-primary font-weight-semi-bold">(+84) 794.859.859</span></small>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <div class="col-12 col-md-6 col-xl-2dot2 mb-6 mb-md-10 mb-xl-0 pr-2">
                ...
                <div class="col-12 col-md-6  col-xl-2 mb-6 mb-md-0">
       ...
       <script src="{{ asset('Home/vendor/jquery-migrate/dist/jquery-migrate.min.js')}}"></script>
       <script src="{{ asset('Home/vendor/popper.js/dist/umd/popper.min.js')}}"></script>
       <script src="{{ asset('Home/vendor/bootstrap/bootstrap.min.js')}}"></script>

       <!-- JS Implementing Plugins -->
       <script src="{{ asset('Home/vendor/hs-megamenu/src/hs.megamenu.js')}}"></script>
       <script src="{{ asset('Home/vendor/jquery-validation/dist/jquery.validate.min.js')}}"></script>
       ...
       <script src="{{ asset('Home/js/components/hs.unfold.js')}}"></script>
       <script src="{{ asset('Home/js/components/hs.validation.js')}}"></script>
       <script src="{{ asset('Home/js/components/hs.show-animation.js')}}"></script>
       <script src="{{ asset('Home/js/components/hs.range-datepicker.js')}}"></script>
       <script src="{{ asset('Home/js/components/hs.selectpicker.js')}}"></script>
