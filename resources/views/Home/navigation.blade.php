    ...
    <div class="u-header__section u-header__shadow-on-show-hide py-3 py-xl-0">
        <div id="logoAndNav" class="container-fluid">
            ...
            <nav class="js-mega-menu navbar navbar-expand-xl u-header__navbar u-header__navbar--no-space py-1">
                <!-- Logo -->
                <a class="navbar-brand u-header__navbar-brand-default u-header__navbar-brand-center u-header__navbar-brand-text-md u-header__navbar-brand-text-dark-xl u-header__divider-xl u-header__divider-right pr-xl-5" href="{{ route('Tous.Tous') }}" aria-label="MyTravel">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="45px" height="43px">
                    ...
                    <span class="u-header__navbar-brand-text font-weight-medium">MyTravel</span>
                </a>
                <!-- End Logo -->
