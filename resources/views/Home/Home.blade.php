...
<div class="js-slick-carousel u-slick" data-autoplay="true" data-autoplay-speed="5000">
    <div class="bg-img-hero-bottom min-height-720 space-top-2 text-center space-top-lg-4"
        style="background-image: url(Home/img/slider/img6.png);"></div>
    <div class="bg-img-hero-bottom min-height-720 space-top-2 text-center space-top-lg-4"
        style="background-image: url(Home/img/slider/img6.png);"></div>
    <div class="bg-img-hero-bottom min-height-720 space-top-2 text-center space-top-lg-4"
        style="background-image: url(Home/img/slider/img6.png);"></div>
        ...
        <div class="tab-content hero-tab-pane">
            <div class="tab-pane fade active show" id="pills-one-example2" role="tabpanel"
                ...
                <div class="card border-0 tab-shadow">
                    <div class="card-body">
                        <form class="js-validate" action="{{route('Tous.search')}}">
                            <div class="row d-block nav-select d-lg-flex mb-lg-3 px-2 px-lg-3">
                                <div class="col-sm-12 col-lg-3dot6 col-xl-3dot7 mb-4 mb-lg-0 ">
                                    <span class="d-block text-gray-1 font-weight-normal text-left mb-0">Khu Vực</span>
                                    <!-- Select -->
                                    <select
                                        ...
                                        title="Chọn khu vực" name="dia_diem" data-style=""
                                        data-live-search="true" data-searchbox-classes="input-group-sm">
                                        @foreach ($khu_vuc as $item)
                                        <option class="border-bottom border-color-1" value="{{ $item->ma_mien }}" data-content='
                                            <span class="d-flex align-items-center">
                                                <span class="font-size-16">{{ $item->ten_mien }}</span>
                                            </span>'>
                                            {{ $item->ten_mien }}}
                                        </option>
                                        @endforeach
                                ...
                                <div class="col-sm-12 col-lg-3dot7 col-xl-3dot6 mb-4 mb-lg-0 ">
                                    <!-- Input -->
                                    <span class="d-block text-gray-1 text-left font-weight-normal mb-0">Ngày khởi hành</span>
                                    <div class="border-bottom border-width-2 border-color-1">
                                        <div id="datepickerWrapperFromOne" class="u-datepicker input-group">
                                            ...
                                            <input
                                                ...
                                                data-rp-date-format="yy/m/d"
                                                data-rp-default-date='["{{ $Time_now }}"]' name="ngay">
                                ...
                                <div class="col-sm-12 col-lg-2dot8 mb-4 mb-lg-0 dropdown-custom">
                                    ...
                                    <a id="basicDropdownClickInvoker"
                                        class="dropdown-nav-link dropdown-toggle d-flex pt-3 pb-2" href="javascript:;"
                                        role="button" aria-controls="basicDropdownClick" aria-haspopup="true"
                                        aria-expanded="false" data-unfold-event="click"
                                        data-unfold-target="#basicDropdownClick" data-unfold-type="css-animation"
                                        ...
                                        <span class="text-black font-size-16 font-weight-semi-bold">2 Rooms - 3
                                            Guests</span>
                                    </a>
                                    <div id="basicDropdownClick" class="dropdown-menu dropdown-unfold col-11 m-0"
                                ...
                                <div class="col-sm-12 col-lg-1dot8 align-self-lg-end text-md-right">
                                    <button type="submit"
                                        class="btn btn-primary btn-md border-radius-3 mb-xl-0 mb-lg-1 transition-3d-hover"><i
                                            class="flaticon-magnifying-glass mr-2"></i>Tìm Kiếm</button>
                                </div>
                            </div>
                            <!-- End Checkbox -->
                        </form>
                ...
                <div class="card border-0 tab-shadow">
                    <div class="card-body">
                        <form class="js-validate">
                            <div class="row d-block nav-select d-lg-flex mb-lg-3 px-2 px-lg-3">
                                <div class="col-sm-12 col-lg-3dot6 col-xl-3dot7 mb-4 mb-lg-0 ">
                                    <span class="d-block text-gray-1 font-weight-normal text-left mb-0">Destination or
                                        Hotel Name</span>
                                    <!-- Select -->
                                    <select
                                        class="js-select selectpicker dropdown-select tab-dropdown col-12 pl-0 flaticon-pin-1 d-flex align-items-center text-primary font-weight-semi-bold"
                                ...
                                <div class="col-sm-12 col-lg-3dot7 col-xl-3dot6 mb-4 mb-lg-0 ">
                                    <!-- Input -->
                                    <span class="d-block text-gray-1 text-left font-weight-normal mb-0">Check In -
                                        Out</span>
                                    <div class="border-bottom border-width-2 border-color-1">
                                ...
                                <div class="col-sm-12 col-lg-2dot8 mb-4 mb-lg-0 dropdown-custom">
                                    ...
                                    <a id="basicDropdownClickInvoker2"
                                        class="dropdown-nav-link dropdown-toggle d-flex pt-3 pb-2" href="javascript:;"
                                        role="button" aria-controls="basicDropdownClick2" aria-haspopup="true"
                                        aria-expanded="false" data-unfold-event="click"
                                        data-unfold-target="#basicDropdownClick2" data-unfold-type="css-animation"
                                        data-unfold-duration="300" data-unfold-delay="300"
                                        data-unfold-hide-on-scroll="true" data-unfold-animation-in="slideInUp"
                                        data-unfold-animation-out="fadeOut">
                                        <i
                                    ...
                                    <div id="basicDropdownClick2" class="dropdown-menu dropdown-unfold col-11 m-0"
                        ...
                        <form class="js-validate">
                            <div class="row d-block nav-select d-lg-flex mb-lg-3 px-2 px-lg-3">
                                ...
                                <div class="col-sm-12 col-lg-3dot7 col-xl-3dot6 mb-4 mb-lg-0 ">
                                    ...
                                    <div class="border-bottom border-width-2 border-color-1">
                                        <div id="datepickerWrapperFromThree" class="u-datepicker input-group">
                                            ...
                                            <input
                                                class="js-range-datepicker font-size-lg-16 shadow-none font-weight-bold form-control hero-form bg-transparent  border-0"
                                                type="date" data-rp-wrapper="#datepickerWrapperFromThree"
                                                data-rp-type="range" data-rp-date-format="M d / Y"
                                                data-rp-default-date='["Jul 7 / 2020", "Aug 25 / 2020"]'>
                                        </div>
                                        <!-- End Datepicker -->
                                ...
                                <div class="col-sm-12 col-lg-2dot8 mb-4 mb-lg-0 dropdown-custom">
                                    ...
                                    <span class="d-block text-gray-1 text-left font-weight-normal mb-0">Rooms and
                                        Guests</span>
                                    <a id="basicDropdownClickInvoker3"
                                        class="dropdown-nav-link dropdown-toggle d-flex pt-3 pb-2" href="javascript:;"
                                        role="button" aria-controls="basicDropdownClick3" aria-haspopup="true"
                                        aria-expanded="false" data-unfold-event="click"
                                        data-unfold-target="#basicDropdownClick3" data-unfold-type="css-animation"
                                        data-unfold-duration="300" data-unfold-delay="300"
                                        data-unfold-hide-on-scroll="true" data-unfold-animation-in="slideInUp"
                                        data-unfold-animation-out="fadeOut">
                                        <i
                                    ...
                                    <div id="basicDropdownClick3" class="dropdown-menu dropdown-unfold col-11 m-0"
                                        aria-labelledby="basicDropdownClickInvoker3">
                                        <div class="w-100 py-2 px-3 mb-3">
                                            <div
                                                class="js-quantity mx-3 row align-items-center justify-content-between">
                                                <span
            ...
            <div class="tab-pane fade" id="pills-four-example2" role="tabpanel"
                        ...
                        <form class="js-validate">
                            <div class="row d-block nav-select d-lg-flex mb-lg-3 px-2 px-lg-3">
                                ...
                                <div class="col-sm-12 col-lg-3dot7 col-xl-3dot6 mb-4 mb-lg-0 ">
                                    ...
                                    <div class="border-bottom border-width-2 border-color-1">
                                        <div id="datepickerWrapperFromFour" class="u-datepicker input-group">
                                            ...
                                            <input
                                                class="js-range-datepicker font-size-lg-16 shadow-none font-weight-bold form-control hero-form bg-transparent  border-0"
                                                type="date" data-rp-wrapper="#datepickerWrapperFromFour"
                                                data-rp-type="range" data-rp-date-format="M d / Y"
                                                data-rp-default-date='["Jul 7 / 2020", "Aug 25 / 2020"]'>
                                        </div>
                                        <!-- End Datepicker -->
                                ...
                                <div class="col-sm-12 col-lg-2dot8 mb-4 mb-lg-0 dropdown-custom">
                                    ...
                                    <span class="d-block text-gray-1 text-left font-weight-normal mb-0">Rooms and
                                        Guests</span>
                                    <a id="basicDropdownClickInvoker4"
                                        class="dropdown-nav-link dropdown-toggle d-flex pt-3 pb-2" href="javascript:;"
                                        role="button" aria-controls="basicDropdownClick4" aria-haspopup="true"
                                        aria-expanded="false" data-unfold-event="click"
                                        data-unfold-target="#basicDropdownClick4" data-unfold-type="css-animation"
                                        data-unfold-duration="300" data-unfold-delay="300"
                                        data-unfold-hide-on-scroll="true" data-unfold-animation-in="slideInUp"
                                        data-unfold-animation-out="fadeOut">
                                        <i
                                    ...
                                    <div id="basicDropdownClick4" class="dropdown-menu dropdown-unfold col-11 m-0"
                                        aria-labelledby="basicDropdownClickInvoker4">
                                        <div class="w-100 py-2 px-3 mb-3">
                                            <div
                                                class="js-quantity mx-3 row align-items-center justify-content-between">
                                                <span
            ...
            <div class="tab-pane fade" id="pills-five-example2" role="tabpanel"
                        ...
                        <form class="js-validate">
                            <div class="row d-block nav-select d-lg-flex mb-lg-3 px-2 px-lg-3">
                                ...
                                <div class="col-sm-12 col-lg-3dot7 col-xl-3dot6 mb-4 mb-lg-0 ">
                                    ...
                                    <div class="border-bottom border-width-2 border-color-1">
                                        <div id="datepickerWrapperFromFive" class="u-datepicker input-group">
                                            ...
                                            <input
                                                class="js-range-datepicker font-size-lg-16 shadow-none font-weight-bold form-control hero-form bg-transparent  border-0"
                                                type="date" data-rp-wrapper="#datepickerWrapperFromFive"
                                                data-rp-type="range" data-rp-date-format="M d / Y"
                                                data-rp-default-date='["Jul 7 / 2020", "Aug 25 / 2020"]'>
                                        </div>
                                        <!-- End Datepicker -->
                                ...
                                <div class="col-sm-12 col-lg-2dot8 mb-4 mb-lg-0 dropdown-custom">
                                    ...
                                    <span class="d-block text-gray-1 text-left font-weight-normal mb-0">Rooms and
                                        Guests</span>
                                    <a id="basicDropdownClickInvoker5"
                                        class="dropdown-nav-link dropdown-toggle d-flex pt-3 pb-2" href="javascript:;"
                                        role="button" aria-controls="basicDropdownClick5" aria-haspopup="true"
                                        aria-expanded="false" data-unfold-event="click"
                                        data-unfold-target="#basicDropdownClick5" data-unfold-type="css-animation"
                                        data-unfold-duration="300" data-unfold-delay="300"
                                        data-unfold-hide-on-scroll="true" data-unfold-animation-in="slideInUp"
                                        data-unfold-animation-out="fadeOut">
                                        <i
                                    ...
                                    <div id="basicDropdownClick5" class="dropdown-menu dropdown-unfold col-11 m-0"
                                        aria-labelledby="basicDropdownClickInvoker5">
                                        <div class="w-100 py-2 px-3 mb-3">
                                            <div
                                                class="js-quantity mx-3 row align-items-center justify-content-between">
                                                <span
                        ...
                        <form class="js-validate">
                            <div class="row d-block nav-select d-lg-flex mb-lg-3 px-2 px-lg-3">
                                ...
                                <div class="col-sm-12 col-lg-3dot7 col-xl-3dot6 mb-4 mb-lg-0 ">
                                    ...
                                    <div class="border-bottom border-width-2 border-color-1">
                                        <div id="datepickerWrapperFromSix" class="u-datepicker input-group">
                                            ...
                                            <input
                                                class="js-range-datepicker font-size-lg-16 shadow-none font-weight-bold form-control hero-form bg-transparent  border-0"
                                                type="date" data-rp-wrapper="#datepickerWrapperFromSix"
                                                data-rp-type="range" data-rp-date-format="M d / Y"
                                                data-rp-default-date='["Jul 7 / 2020", "Aug 25 / 2020"]'>
                                        </div>
                                        <!-- End Datepicker -->
                                ...
                                <div class="col-sm-12 col-lg-2dot8 mb-4 mb-lg-0 dropdown-custom">
                                    ...
                                    <span class="d-block text-gray-1 text-left font-weight-normal mb-0">Rooms and
                                        Guests</span>
                                    <a id="basicDropdownClickInvoker6"
                                        class="dropdown-nav-link dropdown-toggle d-flex pt-3 pb-2" href="javascript:;"
                                        role="button" aria-controls="basicDropdownClick6" aria-haspopup="true"
                                        aria-expanded="false" data-unfold-event="click"
                                        data-unfold-target="#basicDropdownClick6" data-unfold-type="css-animation"
                                        data-unfold-duration="300" data-unfold-delay="300"
                                        data-unfold-hide-on-scroll="true" data-unfold-animation-in="slideInUp"
                                        data-unfold-animation-out="fadeOut">
                                        <i
                                    ...
                                    <div id="basicDropdownClick6" class="dropdown-menu dropdown-unfold col-11 m-0"
                                        aria-labelledby="basicDropdownClickInvoker6">
                                        <div class="w-100 py-2 px-3 mb-3">
                                            <div
                                                class="js-quantity mx-3 row align-items-center justify-content-between">
                                                <span
                        ...
                        <form class="js-validate">
                            <div class="row d-block nav-select d-lg-flex mb-lg-3 px-2 px-lg-3">
                                ...
                                <div class="col-sm-12 col-lg-3dot7 col-xl-3dot6 mb-4 mb-lg-0 ">
                                    ...
                                    <div class="border-bottom border-width-2 border-color-1">
                                        <div id="datepickerWrapperFromSeven" class="u-datepicker input-group">
                                            ...
                                            <input
                                                class="js-range-datepicker font-size-lg-16 shadow-none font-weight-bold form-control hero-form bg-transparent  border-0"
                                                type="date" data-rp-wrapper="#datepickerWrapperFromSeven"
                                                data-rp-type="range" data-rp-date-format="M d / Y"
                                                data-rp-default-date='["Jul 7 / 2020", "Aug 25 / 2020"]'>
                                        </div>
                                        <!-- End Datepicker -->
                                ...
                                <div class="col-sm-12 col-lg-2dot8 mb-4 mb-lg-0 dropdown-custom">
                                    ...
                                    <span class="d-block text-gray-1 text-left font-weight-normal mb-0">Rooms and
                                        Guests</span>
                                    <a id="basicDropdownClickInvoker7"
                                        class="dropdown-nav-link dropdown-toggle d-flex pt-3 pb-2" href="javascript:;"
                                        role="button" aria-controls="basicDropdownClick7" aria-haspopup="true"
                                        aria-expanded="false" data-unfold-event="click"
                                        data-unfold-target="#basicDropdownClick7" data-unfold-type="css-animation"
                                        data-unfold-duration="300" data-unfold-delay="300"
                                        data-unfold-hide-on-scroll="true" data-unfold-animation-in="slideInUp"
                                        data-unfold-animation-out="fadeOut">
                                        <i
                                    ...
                                    <div id="basicDropdownClick7" class="dropdown-menu dropdown-unfold col-11 m-0"
                                        aria-labelledby="basicDropdownClickInvoker7">
                                        <div class="w-100 py-2 px-3 mb-3">
                                            <div
                                                class="js-quantity mx-3 row align-items-center justify-content-between">
                                                <span
...
<main id="content">
    ...
    <div class="destinantion-block destinantion-v1 border-bottom border-color-8">
        <div class="container space-bottom-1 space-top-lg-3">
            ...
            <div class="row mb-1">
                ...
                <img class="min-height-230 bg-img-hero card-img-top" src="Home/img/tour/{{ $item->hinh_anh }}"
                    alt="img">
                </a>
                <div class="position-absolute top-0 right-0 pt-5 pr-3">
                    <button type="button" class="btn btn-sm btn-icon text-white rounded-circle" data-toggle="tooltip"
                        data-placement="top" title="" data-original-title="Save for later">
                ...
                <div class="position-absolute bottom-0 left-0 right-0">
                    <div class="px-3 pb-2">
                        ...
                        <h2 class="h5 text-white mb-0 font-weight-bold"><small
                                class="mr-2">Giá</small>{{ number_format($item->gia_tour,0,'.','.')."    VNĐ" }}</h2>
                    </div>
                </div>
            </div>
            <div class="card-body px-4 py-2">
                <a href="{{ route('Tous.single',$item->ma_tour) }}" class="d-block">
                    <div class="mb-1 d-flex align-items-center font-size-14 text-gray-1">
                        <i class="icon flaticon-pin-1 mr-2 font-size-15"></i> {{ $item->hinh_anh }}
                    </div>
                </a>
                ...
                <div class="mb-1 d-flex align-items-center font-size-14 text-gray-1">
                    <i class="icon flaticon-clock-circular-outline mr-2 font-size-14"></i> {{ $item->so_ngay}} Ngày
                    {{ $item->so_dem }} Đêm
                </div>
            </div>
        </div>
        ...
        <div class="card mb-1 transition-3d-hover shadow-hover-2 tab-card h-100">
            <div class="position-relative mb-2">
                ...
                <div class="position-absolute bottom-0 left-0 right-0">
                    <div class="px-3 pb-2">
                        <span class="text-gray-10 font-weight-normal font-size-14">{{ $item->ten_loai_tour }}</span>
                        <h2 class="h5 text-white mb-0 font-weight-bold"><small class="mr-2">Giá: </small>
                            {{ number_format($item->gia_tour)." VNĐ" }} </h2>
                    </div>
                </div>
            </div>
            <div class="card-body px-4 py-2">
    ...
    <div class="tabs-block tab-v1">
        <div class="container space-1">
            ...
            <!-- Nav Classic -->
            <div class="js-slick-carousel u-slick u-slick--gutters-1" data-slides-show="3" data-slides-scroll="1"
                    ...
                    <div class="col-md-6 col-lg-12 col-xl-3mb-3 mb-md-4 pb-1">
                        <div class="card mb-1 transition-3d-hover shadow-hover-2 tab-card h-100">
                            <div class="position-relative mb-2">
                                <a href="{{ route('Tous.single',$item->ma_tour) }}"
                                    class="d-block gradient-overlay-half-bg-gradient-v5">
                                    <img class="card-img-top" src="{{ asset('Home/img/tour').'/'.$item->hinh_anh}}"
                                        alt="img">
                                </a>
                                <div class="position-absolute top-0 right-0 pt-5 pr-3">
                                ...
                                <div class="position-absolute bottom-0 left-0 right-0">
                                    <div class="px-3 pb-2">
                                        <span
                                            class="text-white font-weight-normal font-size-14">{{ $item->ten_loai_tour }}</span>
                                        <h2 class="h5 text-white mb-0 font-weight-bold"><small
                                                class="mr-2">From</small>{{ number_format($item->gia_tour,0,'.','.')."    VNĐ" }}
                                        </h2>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- End Tabs v1 -->
    <!-- Banner v1-->
    <div class=" banner-block banner-v1 bg-img-hero space-3 " data-aos="fade-up" data-aos-delay="100" id="news"
        style="background-image: url(Home/img/1920x500/banner_tintuc.png);">
        <div class="max-width-650 mx-auto text-center mt-xl-5 mb-xl-2 px-3 px-md-0 " data-aos="fade-up">
            ...
            <p class="text-white font-size-18 font-weight-normal mb-4 pb-1 px-md-3 px-lg-0">Tin tức Du lịch - Tin tức Du
                lịch 2020 cung cấp các thông tin Du lịch Việt Nam, Thông tin Du lịch Thế Giới, các Sự kiện Du lịch diễn
                ra trong ngày. Thông qua các bài viết được cập nhật liên tục, du khách có thể nắm bắt thêm được nhiều
                thông tin hữu ích về du lịch.</p>
            <a class="btn btn-outline-white border-width-2 rounded-xs min-width-200 font-weight-normal transition-3d-hover"
                href="../blog/blog-list.html">Xem ngay !</a>
        </div>
    </div>
    <!-- End Banner v1-->
            ...
            <div class="mb-2">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <p class="text-gray-1 px-xl-2 px-uw-7">Với hơn 500 nhà cung cấp và sức mua của 300 triệu thành
                            viên, mytravel.com có ​​thể giúp bạn tiết kiệm nhiều hơn</p>
                    </div>
                    <!-- End Icon Block -->
                    ...
                    <div class="col-md-4">
                        ...
                        <h5 class="font-size-17 text-dark font-weight-bold mb-2"><a href="#">Dịch vụ dành giải
                                thưởng</a></h5>
                        <p class="text-gray-1 px-xl-2 px-uw-7">Đi du lịch miễn phí khi biết rằng chúng tôi ở đây nếu bạn
                            cần, 24 giờ một ngày</p>
                    </div>
                    <!-- End Icon Block -->
                    ...
                    <div class="col-md-4">
                        ...
                        <p class="text-gray-1 px-xl-2 px-uw-7">Hơn 1.200.000 khách sạn tại hơn 200 quốc gia và khu vực &
                            chuyến bay đến hơn 5.000 thành phố</p>
                    </div>
                    <!-- End Icon Block -->
                </div>
            </div>
    ...
    <div class="deals-carousel-block deals-carousel-v1 border-bottom border-color-8" id="bouns">
        <div class="container space-1">
            ...
            <div class="js-slick-carousel u-slick u-slick--gutters-3" data-slides-show="3"
                        ...
                        <div class="card mb-1 transition-3d-hover shadow-hover-2 tab-card h-100">
                            <div class="position-relative mb-2">
                                ...
                                <div class="position-absolute bottom-0 left-0 right-0">
                                    <div class="px-3 pb-2">
                                        <span
                                            class="text-white font-weight-normal font-size-20">{{ $item->ten_loai_tour }}</span>
                                        <h2 class="h5 text-white mb-0 font-size-17 font-weight-bold"><small
                                                class="mr-2">Giá</small><strike
                                                class="font-size-13">{{ number_format($item->gia_tour,0,'.','.')."    VNĐ" }}</strike>
                                            {{ number_format($item->gia_tour - ($item->gia_tour * ($item->khuyen_mai / 100 )),0,'.','.')."  VNĐ" }}
                                        </h2>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body px-4 py-2">
                                ...
                                <a href="{{ route('Tous.single',$item->ma_tour) }}"
                                    ...
                                    data-animation-class="fadeOutDownBig">{{ $item->ten_tour }}</a>
                                <div class="position-absolute top-0 left-0 pt-5 pl-3">
                                    <span
                                        class="badge badge-pill bg-white text-primary px-4 py-2 font-size-14 font-weight-normal">Khuyến
                                        mãi</span>
                                    <span
