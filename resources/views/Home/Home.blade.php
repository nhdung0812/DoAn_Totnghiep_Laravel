...
<main id="content">
    ...
    <!-- End Tabs v1 -->
    <!-- Banner v1-->
    <div class="banner-block banner-v1 bg-img-hero space-3" id="news" style="background-image: url(Home/img/1920x500/banner_tintuc.png);">
        ...
        <a class="btn btn-outline-white border-width-2 rounded-xs min-width-200 font-weight-normal transition-3d-hover" href="{{route('Tous.tintuc')}}">Xem ngay !</a>
        </div>
    </div>
    <!-- End Banner v1-->
